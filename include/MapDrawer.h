...
class MapDrawer
{
  public:
    ...
    Eigen::Matrix<float, 3, 1> Exit_point;
    std::vector<Eigen::Matrix<float, 3, 1>> RRT_path;

    bool draw_exit = false;
    bool draw_RRT = false;

    void set_draw_exit(bool draw) { this->draw_exit = draw; }
    void set_draw_RRT(bool draw) { this->draw_RRT = draw; }
